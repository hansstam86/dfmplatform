...
const S = StyleSheet.create({
  ...
  td:          { fontSize: 8, padding: 5, color: '#0a0a0a', lineHeight: 1.4, overflow: 'hidden' },
  tdMid:       { fontSize: 8, padding: 5, color: '#555', lineHeight: 1.4, overflow: 'hidden' },
  tdMono:      { fontSize: 7, padding: 5, color: '#888', fontFamily: 'Courier', overflow: 'hidden' },
  tdCenter:    { fontSize: 8, padding: 5, textAlign: 'center', fontFamily: 'Helvetica-Bold', overflow: 'hidden' },
